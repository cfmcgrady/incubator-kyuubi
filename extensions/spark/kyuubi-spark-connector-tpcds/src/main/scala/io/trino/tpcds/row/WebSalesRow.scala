...
class WebSalesRow(
                   ...
                   private val wsPricing: Pricing
  ) extends TableRowWithNulls(nullBitMap, WS_SOLD_DATE_SK)
  ...
  def internalRow: InternalRow =
    ...
    getIntOrNull(wsPricing.getQuantity(), WS_PRICING_QUANTITY),
        ...
        getDecimalOrNull(wsPricing.getNetPaidIncludingShippingAndTax, WS_PRICING_NET_PAID_INC_SHIP_TAX, 7, 2),
